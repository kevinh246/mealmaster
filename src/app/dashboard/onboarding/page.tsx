...
export default function Page() {
  ...
  function handleCompleteOnboarding() {
    ...
    if (weight <= 200 && age < 100) {
      completeOnboarding(gender, Number(weight), Number(age), activity).then(
        () => {
      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <option value="NoRarely active">
              Rarely active (max 3 times exercise per week)
            </option>
          ...
          {hasError && (
            <p className="text-red-600 mt-2">Weight or age is invalid</p>
          )}
        </form>
      </Container>
    </>
