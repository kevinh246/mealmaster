  ...
  return (
    <dialog id="fruit_modal" className="modal" ref={fruitsModalRef}>
      <div className="modal-box rounded-md">
        <h3 className="font-medium text-2xl text-center">Select fruit types</h3>
        ...
        <div className="px-10 mt-5">
          <div className="flex mb-5">
            <input
              ...
              checked={apple}
              onChange={(e) =>
                handleFruitsChange(setApple, "Apple", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={orange}
              onChange={(e) =>
                handleFruitsChange(setOrange, "Orange", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={pineapple}
              onChange={(e) =>
                handleFruitsChange(setPineapple, "Pineapple", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={grape}
              onChange={(e) =>
                handleFruitsChange(setGrape, "Grape", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={kiwi}
              onChange={(e) =>
                handleFruitsChange(setKiwi, "Kiwi", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={durian}
              onChange={(e) =>
                handleFruitsChange(setDurian, "Durian", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={pear}
              onChange={(e) =>
                handleFruitsChange(setPear, "Pear", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={banana}
              onChange={(e) =>
                handleFruitsChange(setBanana, "Banana", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={mango}
              onChange={(e) =>
                handleFruitsChange(setMango, "Mango", e.target.checked)
              }
            />
