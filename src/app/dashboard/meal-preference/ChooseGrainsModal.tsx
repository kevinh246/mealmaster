  ...
  return (
    <dialog id="grain_modal" className="modal" ref={grainModalRef}>
      <div className="modal-box rounded-md">
        <h3 className="font-medium text-2xl text-center">Select grain types</h3>
        ...
        <div className="px-10 mt-5">
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={quinoa}
              onChange={(e) =>
                handleGrainsChange(setQuinoa, "Quinoa", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={oats}
              onChange={(e) =>
                handleGrainsChange(setOats, "Oats", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={barley}
              onChange={(e) =>
                handleGrainsChange(setBarley, "Barley", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={corn}
              onChange={(e) =>
                handleGrainsChange(setCorn, "Corn", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={soyMilk}
              onChange={(e) =>
                handleGrainsChange(setSoyMilk, "Soy milk", e.target.checked)
              }
            />
          ...
          <div className="flex mb-5">
            <input
              ...
              checked={oatMilk}
              onChange={(e) =>
                handleGrainsChange(setOatMilk, "Oat milk", e.target.checked)
              }
            />
